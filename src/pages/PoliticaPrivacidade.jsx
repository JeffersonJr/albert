                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 mb-8">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-gray-700 font-medium">Criptografia</p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-gray-700 font-medium">Firewall</p>
                                            <p className="text-gray-700 text-sm">
                                    ...
                                    <div className="flex items-start gap-3">
                                        <Database className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                                        <div>
                                            <p className="text-gray-700 font-medium">Backups</p>
                                            <p className="text-gray-700 text-sm">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-gray-700 font-medium">Monitoramento</p>
                                            <p className="text-gray-700 text-sm">
