                ...
                <div className="flex-1 flex justify-center items-center perspective-[1200px]">
                    <div className="relative transform-style-3d">
                        <img
                            ...
                            className="w-full rounded-3xl shadow-strong rotate-x-[10deg] -rotate-y-[10deg] rotate-z-[2deg] animate-float-3d"
                        />

                        {/* Floating Cards */}
                        <div
                            ref={card1Ref}
                            className="absolute top-[10%] -right-8 bg-white/70 backdrop-blur-md border border-white/40 p-4 rounded-2xl flex items-center gap-3 shadow-strong z-10 translate-z-[50px]"
                        >
                        ...
                        <div
                            ref={card2Ref}
                            className="absolute bottom-[15%] -left-10 bg-white/70 backdrop-blur-md border border-white/40 p-4 rounded-2xl flex items-center gap-3 shadow-strong z-10 translate-z-[80px]"
                        >
