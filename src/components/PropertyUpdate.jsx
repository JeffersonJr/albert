        ...
        <section className="py-24 bg-[#F8FAFA] overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 relative">
                    ...
                    >
                        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center group hover:scale-105 transition-transform">
                            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 mb-6 font-bold text-2xl relative">
                ...
                <motion.div 
                    ...
                    className="mt-20 p-8 bg-white border border-gray-100 rounded-3xl shadow-lg flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto"
                >
                    <div className="flex-1">
                        <p className="text-secondary font-bold text-lg md:text-xl text-center md:text-left">
                    ...
                    <button 
                        onClick={() => window.open('https://wa.me/5513997591781', '_blank')}
                        className="w-full md:w-auto px-8 py-4 bg-secondary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-black transition-colors"
                    >
