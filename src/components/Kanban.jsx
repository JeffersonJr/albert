...
import { Zap, Clock, ChevronRight, MoreHorizontal, ArrowRight } from 'lucide-react';
...
const Kanban = () => {
    ...
    return (
        <section ref={sectionRef} className={`relative bg-[#F8FAFB] transition-all duration-500 py-20 pb-12`}>
                ...
                <div className={`relative`}>
                    <div className="container mx-auto">
                        <div className="text-center mb-16 px-6">
                            ...
                            <div className={`transition-opacity duration-300 flex items-center justify-center gap-2 text-primary/60 text-sm font-bold uppercase tracking-widest mt-8`}>
